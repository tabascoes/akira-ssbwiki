export default {
  repository: 'https://github.com/tabascoes/next-ssbwiki',
  docsRepository: 'https://github.com/tabascoes/next-ssbwiki',
  titleSuffix: ' – SSBWikiNext',
  logo: (
    <>
      <span className="mr-2 font-extrabold hidden md:inline">SSBWikiNext</span>
